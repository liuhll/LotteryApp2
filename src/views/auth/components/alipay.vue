<template>
  <div>
    ...
    <div class="mod-ct">
        ...
        <div class ="paybtn"><a :href="payinfo.qrCode" id="alipaybtn" class="btn btn-primary" target="_blank">启动支付宝App支付</a></div>
...
.ico-1 {
    background: url("../../../assets/images/pay/logo_alipay.jpg") no-repeat;
